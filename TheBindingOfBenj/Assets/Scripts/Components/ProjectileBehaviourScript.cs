...
public class ProjectileBehaviourScript : MonoBehaviour
{
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        {
            if (EnemyLayer == (EnemyLayer | (1 << collision.gameObject.layer))) // si le tireur touche bien un collider appartenant à la EnemyLayer
            {
            ...
            else // tir d'un ennemi sur un de ses alliés
            {
